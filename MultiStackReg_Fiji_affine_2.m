function tform_cum_ordered = MultiStackReg_Fiji_affine_2(mean_vol,fdir,Nz)
...
% MIJ.run('MultiStackReg', ['stack_1=[Import from Matlab] action_1=Align file_1=E:\XXX.txt stack_2=None action_2=Ignore file_2=[] transformation=Affine save']);
MIJ.run('Close');
MIJ.exit;
